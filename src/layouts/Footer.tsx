    ...
    <footer className="bg-romio-black text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <Link to="/" className="inline-block mb-4">
              <img src={logoPath} alt="Romio Mobile" className="h-16 brightness-0 invert" />
            </Link>
          ...
          {footerLinks.map((column) => (
            <div key={column.title} className="col-span-1">
              <h3 className="text-base sm:text-lg font-semibold mb-4">{column.title}</h3>
                ...
                {column.links.map((link) => (
                  <li key={link.name}>
                    {link.isLink ? (
                      ...
                      <a href={link.href} className="text-steel-gray hover:text-dark-theme transition-colors text-sm sm:text-base">
                        {link.name}
                      </a>
                    )}
                  </li>
        ...
        <div className="mt-12 pt-6 border-t border-gray-800">
          <div className="flex flex-col md:flex-row items-center justify-between bg-gray-800 p-4 md:p-6 rounded-lg">
            <div className="mb-4 md:mb-0 text-center md:text-left">
              <h3 className="text-xl font-semibold mb-2">Romio for Business</h3>
            ...
            <Link 
              to="/business" 
              className="bg-dark-theme hover:bg-opacity-90 text-white py-2 px-6 rounded-lg transition-colors whitespace-nowrap"
            >
              Learn More
            </Link>
          </div>
