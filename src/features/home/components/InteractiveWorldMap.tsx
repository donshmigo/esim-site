...
const countryNameToCode: Record<string, string> = {
  ...
  'Brazil': 'BRA', 'Bulgaria': 'BGR', 'Canada': 'CAN', 'Croatia': 'HRV',
  'Cyprus': 'CYP', 'Czech Republic': 'CZE', 'Denmark': 'DNK', 'Estonia': 'EST',
  'Faroe Islands': 'FRO', 'Finland': 'FIN', 'France': 'FRA', 'Georgia': 'GEO',
  'Germany': 'DEU', 'Ghana': 'GHA', 'Greece': 'GRC', 'Hong Kong': 'HKG',
  'Hungary': 'HUN', 'Iceland': 'ISL', 'India': 'IND', 'Indonesia': 'IDN',
  'Iraq': 'IRQ', 'Ireland': 'IRL', 'Israel': 'ISR', 'Italy': 'ITA',
  'Japan': 'JPN', 'Kazakhstan': 'KAZ', 'Kosovo': 'XKX', 'Kuwait': 'KWT', 
  'Kyrgyzstan': 'KGZ', 'Latvia': 'LVA', 'Liechtenstein': 'LIE', 'Lithuania': 'LTU', 
  'Luxembourg': 'LUX', 'Macao China': 'MAC', 'Macedonia': 'MKD', 'Malaysia': 'MYS', 
  'Malta': 'MLT', 'Moldova': 'MDA', 'Montenegro': 'MNE', 'Netherlands': 'NLD', 
  'New Zealand': 'NZL', 'Norway': 'NOR', 'Pakistan': 'PAK', 'Philippines': 'PHL', 
  'Poland': 'POL', 'Portugal': 'PRT', 'Qatar': 'QAT', 'Reunion': 'REU', 
  'Romania': 'ROU', 'Russian Federation': 'RUS', 'Serbia': 'SRB', 'Singapore': 'SGP', 
  'Slovakia': 'SVK', 'Slovenia': 'SVN', 'South Korea': 'KOR', 'Spain': 'ESP', 
