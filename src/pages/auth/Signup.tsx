          ...
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div>
              ...
              <input
                ...
                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-steel-gray placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-signal-blue focus:border-signal-blue focus:z-10 sm:text-sm"
