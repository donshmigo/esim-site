          ...
          <div className="hidden lg:block lg:col-span-1">
            <div className="sticky top-24 bg-white rounded-xl border-2 border-signal-blue p-6 shadow-lg">
              <div className="mb-6 text-center">
                ...
                <div className="text-4xl font-bold text-signal-blue mb-2">{t('pricing.lite.price')} <span className="text-lg font-normal text-cool-slate">/{t('common.month')}</span></div>
