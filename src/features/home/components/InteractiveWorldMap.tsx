...
const countryNameToCode: Record<string, string> = {
  ...
  'Brazil': 'BRA', 'Bulgaria': 'BGR', 'Cambodia': 'KHM', 'Canada': 'CAN', 'China': 'CHN', 
  'Croatia': 'HRV', 'Cyprus': 'CYP', 'Czech Republic': 'CZE', 'Denmark': 'DNK', 
  'Egypt': 'EGY', 'Estonia': 'EST', 'Faroe Islands': 'FRO', 'Finland': 'FIN', 
  'France': 'FRA', 'French Guiana': 'GUF', 'Georgia': 'GEO', 'Germany': 'DEU', 
  'Ghana': 'GHA', 'Gibraltar': 'GIB', 'Greece': 'GRC', 'Hong Kong': 'HKG', 
  'Hungary': 'HUN', 'Iceland': 'ISL', 'India': 'IND', 'Indonesia': 'IDN', 
  'Iraq': 'IRQ', 'Ireland': 'IRL', 'Israel': 'ISR', 'Italy': 'ITA', 'Japan': 'JPN',
  'Kazakhstan': 'KAZ', 'Kosovo': 'XKX', 'Kuwait': 'KWT', 'Kyrgyzstan': 'KGZ', 
  'Laos': 'LAO', 'Latvia': 'LVA', 'Liechtenstein': 'LIE', 'Lithuania': 'LTU', 
  'Luxembourg': 'LUX', 'Macao China': 'MAC', 'Macedonia': 'MKD', 
  'Macedonia-the former Yugoslav Republic of': 'MKD', 'Madagascar': 'MDG',
  'Malaysia': 'MYS', 'Malta': 'MLT', 'Mexico': 'MEX', 'Moldova': 'MDA', 
  'Montenegro': 'MNE', 'Netherlands': 'NLD', 'New Zealand': 'NZL', 'Norway': 'NOR', 
  'Pakistan': 'PAK', 'Philippines': 'PHL', 'Poland': 'POL', 'Portugal': 'PRT', 
  'Qatar': 'QAT', 'Romania': 'ROU', 'Russian Federation': 'RUS', 'Saudi Arabia': 'SAU',
  ...
  'United Kingdom': 'GBR', 'United States': 'USA', 'Uzbekistan': 'UZB', 'Vietnam': 'VNM'
};
